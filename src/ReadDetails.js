...
module.exports = class ReadDetailsPage extends Page {
  ...
  _createUI() {
    this.append(
      new ScrollView().append(
        new TextView({id: 'topik_forumLabel', text: this.topik_forum}),
  ...
  _applyLayout() {
    this.apply({
      '#topik_forumLabel': {left: 16, top: 16, right: 16},
  ...
  _applyStyles() {
    this.apply({
      '#topik_forumLabel': {textColor: 'rgba(0, 0, 0, 0.5)', font: 'bold 14px sans-serif'},
